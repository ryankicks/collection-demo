...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'home_collection', 'start_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 10, 2, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collection.start_date'
        db.delete_column(u'home_collection', 'start_date')
    ...
    models = {
        ...
        u'home.collection': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 2, 0, 0)', 'blank': 'True'}),
